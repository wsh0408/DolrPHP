<div class="clearfix"></div>
       ...
       <div class="traceInfo" id="DolrPHPtraceInfo" style="display:none;">
        <div class="head"><span class="hd left">TRACE:</span><span class="close" onclick="var x=document.getElementById('DolrPHPtraceInfo');x.style.display='none';document.getElementById('dolrTraceTool').style.display='block';">—</span></div>
            <div class="content">
